...
| [Go](https://open-vsx.org/extension/golang/Go) | ✅ Working | Works out of the box, automatically install related binaries. | ![version](https://img.shields.io/badge/dynamic/json?url=https://open-vsx.org/api/golang/Go&query=$.version&label=&color=brightgreen) |
